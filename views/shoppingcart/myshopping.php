...
<div class="list-item-grouper" data-js="list-item-grouper" data-id="list_item_grouper_d8d77ea6db98">
  <div class="list-item-grouper--header">
      <span class="list-item-grouper--text" aria-label="5 de junio">
          <span data-js="rich-text" aria-hidden="true" class="bf-ui-rich-text bf-ui-rich-text--bold">5 de junio</span>              
      </span>
  </div>
  <div class="list-item" data-js="list-item" data-id="list_item_d48c5edd2f0d">
    <div class="list-item__product">
      <div data-js="image" class="list-item__image">
          <img decoding="async" src="https://http2.mlstatic.com/D_846526-MLM31222347191_062019-I.jpg" class="bf-ui-image--default" alt="Tp-link 150mbp Adaptador Alta Potencia Rompemuro Tl-wn8200nd">
      </div>
      <div class="list-item__data">
        ...
        <h3 class="list-item__title" data-js="title" aria-label="Lo retiraste el 11 de junio&nbsp;&nbsp;">
            <span data-js="rich-text" aria-hidden="true" class="bf-ui-rich-text">Lo retiraste el 11 de junio&nbsp;&nbsp;</span>
        ...
        <p class="list-item__link" data-js="link" aria-label="Tp-link 150mbp Adaptador Alta Potencia Rompemuro Tl-wn8200nd Una unidad." tabindex="0" role="button">
            <span data-js="rich-text" aria-hidden="true" class="bf-ui-rich-text">Tp-link 150mbp Adaptador Alta Potencia Rompemuro Tl-wn8200nd</span>
        </p>
        <p class="list-item__info" data-js="info" aria-label="Tp-link 150mbp Adaptador Alta Potencia Rompemuro Tl-wn8200nd Una unidad."><span data-js="rich-text" aria-hidden="true" class="bf-ui-rich-text">1 unidad</span>
        </p>
      </div>
    </div>
