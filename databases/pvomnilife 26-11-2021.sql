...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2021 a las 04:14:11
...
(1, 'Mangus', 'resources/images/products/slider12.webp', 'sss', 1, NULL, 1, 20, '156'),
(2, 'One mix', 'sss', 'sss', 2, NULL, 2, 23, '16'),
(3, 'Fibra', 'SXu8ba1LfDM_9zl3c9fMR8vuk29cEGEy.jpg', 'Suplemento Alimenticio', 2, NULL, 2, 20, '245'),
(4, 'Prueba', 'SAiFJL8Cw6NyvmBdHUPf4jInBbSFoipr.png', 'Prueba', 1, 1, 1, 3, '456'),
(5, 'Pruebaaaa', 'UnB-tdUxqt5UgRJBNZzMz8x0eaoqNu6b.jpg', 'Pruebaaa', 1, 1, 1, 6, '789');
...
--
ALTER TABLE `flavor`
  MODIFY `idflavor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `unittype`
  MODIFY `idunittype` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
