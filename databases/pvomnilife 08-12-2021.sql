...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-12-2021 a las 21:22:23
...
INSERT INTO `card` (`idcard`, `fkbank`, `cardnumber`, `expirationdate`, `securitycode`, `namelastname`, `type`) VALUES
(1, 1, '4234 2343 4234 2342', '12/2721', '123', 'HOla eqweqwdqw vc', 'Debito');
...
--
ALTER TABLE `shoppingcart`
  MODIFY `idshoppingcart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
