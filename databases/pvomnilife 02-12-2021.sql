...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2021 a las 19:57:34
...
(14, 'Cafezzino Plus', 'qaOeHIBUYskjNM5Ke15ESmkJSzDVhylt.jpg', 'Producto nutricional con café colombiano, extracto de café verde, cromo y fibra. Ayuda a utilizar la grasa almacenada como fuente de energía.', 3, '5 g', 2, 20, '17'),
(15, ' Volver a productos Cajas Ego Life Supreme', 'LF0SbCdryZKRi6kBOwXyLA5CyExxnvkK.jpg', 'Producto nutricional sabor piña, con electrólitos.', 5, '16 g', 2, 5, '12'),
(16, 'Magnus Supreme', 'hT3gDejWwM5ntCqYb8dP9PWv3bt-ZBrg.jpg', 'Producto nutricional sabor a cítrico, con vitaminas del complejo B, glicina y taurina.', 7, '8 g', 2, 13, '19');
...
(1, 'Yesenia', 'Díaz Hernández', '6647661256', 'yesenia@gmail.com', 'Comprador', 1),
(2, 'Carlos ', 'Angel Padilla', '1234567809', 'carlos@gmail.com', 'Comprador', 1),
(3, 'Maria', 'Gordillo Hernández', '0987654321', 'maria@gmail.com', 'Vendedor', 1);
...
(2, 2, 'Maria luisa Espinosa Guzman', '29580', 'Chiapas', 'Playas de catazá', 'La tuza', 'Principal', NULL, NULL, 'Casa', '0987654321', NULL);
...
(2, '2021-11-19 11:10:21', 1, 'sssss', 'No Enviado');
...
(4, 'cliente', 'AT5QKhYPf4qAMuyhADQwTobvPQn_RPwm', '$2y$13$tm6D1pR25/kIu5//ZyzM0..CKiVYUxlEj9eEs5q9h2xEQm9ANDH2i', NULL, 1, 0, 1638049796, 1638049796, '127.0.0.1', '', '', 0),
...
--
ALTER TABLE `shopping`
  MODIFY `idshopping` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
